      ...
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            ...
            <p className="ft-description">
              ...
              continue delivering the best products and services. We are
              Canadian Innovative IT consultancy.
            </p>
          </div>
        ...
        <div className="ft-list">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="#services">Data and Analytics</a>
            </li>
            <li>
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@healthplus.com">
                support@techenthusiast.com
              </a>
            </li>
            <li>
              <a href="mailto:appointment@healthplus.com">
                contact@techenthusiast.com
              </a>
            </li>
            <li>
            ...
            <li>
              <p className="">
                207-7923 Coronet RD NW, <br />
                Edmonton, Alberta T6E4N7.<br /><br />
                Branch Office: Ontario<br /><br />
                4655 Metcalfe Ave, Suite 1609B, <br />
                Mississuage, Ontario L5M0Z7
              </p>
            </li>
          </ul>
        </div>
